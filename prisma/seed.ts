...
const CATEGORIES: Array<{
  ...
  { name: "Beef Cuts", slug: "beef-cuts", image: img("08.jpg") },
  { name: "Dairy Products", slug: "dairy-products", image: img("Sahiwal-Cow.webp") },
  { name: "Goat Meat", slug: "goat-meat", image: img("somali-goats.jpg") },
  { name: "Sheep Meat", slug: "sheep-meat", image: img("dorper-sheep-1024x538.jpg") },
  { name: "Vegetables", slug: "vegetables", image: img("WhatsApp Image 2026-08-10 at 11.56.41.jpeg") },
  { name: "Fruits", slug: "fruits", image: img("WhatsApp Image 2026-08-10 at 11.56.40.jpeg") },
  { name: "Ranch Box", slug: "ranch-box", image: img("WhatsApp Image 2026-08-10 at 11.55.21.jpeg") },
]
...
const PRODUCTS: Record<string, Array<{
  ...
  "Dairy Products": [
    ...
    },
    {
      ...
      price: 950,
      unit: "350g jar",
      image: img("sahiwal-bull-500x500.webp"),
      inStock: true,
      stockQty: 25,
      featured: false,
    },
  ...
  Vegetables: [
    {
      ...
      price: 80,
      unit: "500g bunch",
      image: img("WhatsApp Image 2026-08-10 at 11.56.41.jpeg"),
      inStock: true,
      stockQty: 50,
      featured: true,
    },
    {
      ...
      price: 250,
      unit: "kg",
      image: img("WhatsApp Image 2026-08-10 at 11.56.43.jpeg"),
      inStock: true,
      stockQty: 40,
      featured: false,
    },
  ...
  Fruits: [
    {
      ...
      price: 1500,
      unit: "5kg box",
      image: img("WhatsApp Image 2026-08-10 at 11.56.40.jpeg"),
      inStock: true,
      stockQty: 20,
      featured: true,
    },
  ...
  "Ranch Box": [
    {
      ...
      price: 4200,
      unit: "weekly box",
      image: img("WhatsApp Image 2026-08-10 at 11.55.21.jpeg"),
      inStock: true,
      stockQty: 99,
      featured: true,
    },
