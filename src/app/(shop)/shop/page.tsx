...
export const metadata = {
  title: "Shop Harvest & Barn Store — Osotua Farming",
  description: "Browse organic garden harvests, pesticide-free produce, raw dairy, and 100% pasture-raised beef cuts direct from Kajiado, Kenya.",
}
      ...
      >
        ...
        <div className="os-container" style={{ position: "relative", zIndex: 1 }}>
          ...
          <p style={{ color: "#5C4835", maxWidth: "540px", lineHeight: 1.8, fontSize: "1.05rem", marginBottom: "2.5rem" }}>
            Order directly from our farm store. Every product carries the Osotua promise — raised here in Kajiado, handled with artisanal care, and delivered fresh to your doorstep.
          </p>
