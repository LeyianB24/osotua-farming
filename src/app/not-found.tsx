...
export default function NotFound() {
  return (
    <div style={{ background: "#FBF7F0", minHeight: "85vh" }} className="flex flex-col justify-between pt-12 text-[#1C1208]">
      <div className="flex items-center justify-center p-6 my-auto">
        ...
        >
          <div className="w-16 h-16 rounded-2xl bg-[#C4882A]/12 border border-[#C4882A]/30 text-[#C4882A] flex items-center justify-center mx-auto text-2xl">
          ...
          <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link
              ...
              className="p-4 text-left transition-colors group flex items-center justify-between hover:border-[#C4882A] no-underline"
            >
              <div>
                ...
                <p className="text-[11px] text-[#786550] mt-1 m-0">Browse fresh farm produce</p>
              </div>
            ...
            >
              <div>
                ...
                <p className="text-[11px] text-[#786550] mt-1 m-0">Pedigree cattle, sheep &amp; goats</p>
              </div>
              <i className="bi bi-arrow-right text-sm text-[#786550] group-hover:text-[#C4882A] group-hover:translate-x-1 transition-all" />
            </Link>
          </div>
          ...
          <div className="pt-4 border-t border-[#C4882A]/15">
            <Link
              href="/"
              className="text-xs font-mono text-[#8E5E16] font-bold hover:text-[#C4882A] uppercase tracking-wider flex items-center justify-center gap-1.5 no-underline"
            >
