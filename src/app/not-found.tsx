...
import { Compass, ArrowRight, Store, Dna } from "lucide-react"
  ...
  return (
    <div className="min-h-[85vh] bg-[#1C1208] flex items-center justify-center p-6 text-[#FBF7F0]">
      <div className="max-w-lg w-full text-center space-y-6 bg-white/[0.03] border border-white/10 p-8 sm:p-12 rounded-2xl backdrop-blur-md shadow-2xl">
        <div className="w-16 h-16 rounded-full bg-[#C4882A]/20 border border-[#C4882A]/30 text-[#C4882A] flex items-center justify-center mx-auto">
          <Compass className="w-8 h-8 animate-spin" style={{ animationDuration: "12s" }} />
        </div>

        <div>
          <span className="font-mono text-[10px] uppercase tracking-widest text-[#C4882A]">Error 404 • Lost in Pasture</span>
        ...
        <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          >
            <div>
              <div className="flex items-center gap-2 text-xs font-semibold text-[#FBF7F0] group-hover:text-[#C4882A]">
                <Store className="w-4 h-4 text-[#C4882A]" />
                <span>Visit Barn Store</span>
              </div>
              <p className="text-[11px] text-[#FBF7F0]/50 mt-1">Browse fresh farm produce</p>
            </div>
            <ArrowRight className="w-4 h-4 text-[#FBF7F0]/40 group-hover:text-[#C4882A] group-hover:translate-x-1 transition-all" />
          </Link>
          ...
          >
            <div>
              <div className="flex items-center gap-2 text-xs font-semibold text-[#FBF7F0] group-hover:text-[#C4882A]">
                <Dna className="w-4 h-4 text-[#3D6B3E]" />
        ...
        <div className="pt-4 border-t border-white/10">
          <Link
            href="/"
            className="text-xs font-mono text-[#C4882A] hover:underline uppercase tracking-wider"
          >
