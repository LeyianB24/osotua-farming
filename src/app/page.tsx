      ...
      <div className="bg-[#FBF7F0] pt-16">
        ...
        <section className="relative min-h-screen flex items-center overflow-hidden gradient-earth">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-[#C4882A]/10 blur-3xl" />
            <div className="absolute bottom-1/3 left-1/6 w-80 h-80 rounded-full bg-[#3D6B3E]/15 blur-3xl" />
          </div>

          {/* Live Rangeland Weather Widget */}
          <div className="absolute top-24 right-8 z-20 hidden xl:flex items-center gap-4 bg-[#1C1208]/80 backdrop-blur-md border border-[#C4882A]/30 p-3.5 rounded-md text-[#F5EFE4] text-xs shadow-xl">
          ...
          <div className="absolute top-0 right-0 bottom-0 w-2/5 hidden lg:flex flex-col justify-center gap-3 pr-16 pt-24 pointer-events-none select-none">
            {[
              ...
              <span
                key={tag.label}
                className="eyebrow-plain text-[#C4882A] border border-[#C4882A]/30 bg-[#1C1208]/60 backdrop-blur-xs px-3 py-1.5 w-fit rounded-sm text-[9px] shadow-sm"
                style={{
          ...
          <div className="container relative z-10 py-36">
            <div className="max-w-2xl">
              ...
              <p className="text-[#F5EFE4]/70 text-lg leading-relaxed max-w-lg mb-12">
                A modern smart farm raising premium indigenous livestock, growing organic food,
                and delivering directly to your table. Authentic genetics. Sustainable stewardship.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
              {[
                ...
                <Link
                  key={item.label}
                  href="/breeds"
                  className={`reveal ${item.bg} p-8 relative overflow-hidden group block rounded-sm shadow-md hover:-translate-y-1 transition-all`}
                ...
                >
                  ...
                  <div className="mt-6 eyebrow-plain text-[#C4882A] text-[9px] group-hover:translate-x-1 transition-transform flex items-center gap-1">
            ...
            {breeds.length > 0 && (
              <>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Link href="/breeds" className="btn btn-outline btn-sm">View All Breeds</Link>
                </div>
        ...
        <section className="section bg-[#FBF7F0]">
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              {/* Visual panel */}
              <div className="gradient-grass rounded p-12 relative overflow-hidden min-h-96 flex flex-col justify-between reveal shadow-xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                >
                  ...
                  <span className="eyebrow-plain text-[#C4882A] text-[9px] group-hover:translate-x-1 transition-transform flex items-center gap-1">
                    <span>{item.cta}</span>
                    <ArrowRight size={12} />
                  </span>
                </Link>
        ...
        <section className="section-sm bg-[#FBF7F0] border-y border-[#EDE5D8]">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              <div className="font-serif text-[#1C1208]/20 text-8xl leading-none mb-4">&ldquo;</div>
