  ...
  return (
    <section className="py-24 md:py-32" style={{ backgroundColor: "#1C1208" }}>
      <div className="os-container">
        ...
        {/* Gallery Grid: Exact Screenshot 3 Mosaic Layout */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-stretch">
          {/* Left Tall Image (Col 1-4) */}
          <div className="md:col-span-4 relative min-h-[380px] md:min-h-[560px] overflow-hidden group rounded-[0px]">
            <Image
          ...
          <div className="md:col-span-4 flex flex-col gap-5">
            ...
            <div className="relative h-[270px] overflow-hidden group rounded-[0px]">
              <Image
          ...
          {/* Right 2 Stacked Images (Col 9-12 matching Screenshot 3) */}
          <div className="md:col-span-4 flex flex-col gap-5">
            {/* Right Top: Fresh Farm Produce Box */}
            <div className="relative h-[270px] overflow-hidden group rounded-[0px]">
              <Image
            ...
            {/* Right Bottom: Rangeland Pasture Landscape */}
            <div className="relative h-[270px] overflow-hidden group rounded-[0px]">
              <Image
                src="/images/WhatsApp Image 2026-08-10 at 11.55.23.jpeg"
                alt="Pastoral grazing pastures at Osotua"
                fill
                sizes="(min-width: 1024px) 33vw, 100vw"
                className="object-cover group-hover:scale-105 transition-transform duration-700 ease-out"
              />
