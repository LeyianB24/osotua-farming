...
export default auth((req) => {
  ...
  const isApiAdminMutation =
    ...
    // Allow public creation of visits, partners, and applications
    !(pathname === "/api/visits" && req.method === "POST") &&
    !(pathname === "/api/partners" && req.method === "POST") &&
    !(pathname.includes("/applications") && req.method === "POST")
